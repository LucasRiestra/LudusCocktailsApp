...
function App() {
  ...
  const { searchTerm, onSearchChange, onSearchSubmit, filteredCocktails, searchError, noResults, onCategoryChange, categoryFilter, selectedCategory, currentPage, setCurrentPage, popularCocktails
